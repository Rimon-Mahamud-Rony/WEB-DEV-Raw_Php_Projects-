<?php
 session_start();
 $page_name = 'Home | Student Registration System';
...
<div id="logo" class="col-sm-3" style="float: right;">
        <div id="border" class="container" >
            <div class="container">
                <table class="table table-striped table-sm table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td>
                            <?php echo "<img src='{$user_img}' class='card-img-top' style='border-radius: 50%;' height='200px;'" ?>
                            </td>
                        </tr>
                        <tr>
            ...
            <!--
                <h6><span style="color:#416180;">Admin name: </span> <?php echo $username;?></h6>
                <h6><span style="color:#416180;">Admin Email: </span> <?php echo $user_email;?></h6>
                <h6><span style="color:#416180;">Admin Id: </span> <?php echo $user_id?></h6>
                <h6 style="color:#416180;">Admin: <br> <?php echo "<img src='{$user_img}' height='20%' width='40%' style='border-radius: 50%;' "?></h6>
